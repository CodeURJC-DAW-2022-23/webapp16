...
public class testDataInitializer{
   ...
   private TripRepository tripRepository;
    ...
    public void init() throws  IOException, URISyntaxException {
      ...
      try {
            setDestinationImage(madrid, "/resources/images/Madrid.jpg");
      } 
      catch (IOException e) {
            e.printStackTrace();
      }
